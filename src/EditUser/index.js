		...
		<div>
			...
			<form onSubmit={props.closeAndEdit}>
				...
				Dungeons and Dragons 5e:
          		<input name="dnd5e" type="checkbox" value={"props.userToEdit.dnd5e"} onChange={props.handleInputChange} /> <br/>
          		Pathfinder:
          		<input name="pathfinder" type="checkbox" value={"props.userToEdit.pathfinder"} onChange={props.handleInputChange} /> <br/>
          		StarFinder:
          		<input name="starfinder" type="checkbox" value={"props.userToEdit.starfinder"} onChange={props.handleInputChange} /> <br/>
          		Dungeons and Dragons 3.5:
          		<input name="dnd3_5" type="checkbox" value={"props.userToEdit.dnd3_5"} onChange={props.handleInputChange} /> <br/>
          		Call of Cthulhu:
          		<input name="callOfCthulu" type="checkbox" value={"props.userToEdit.callOfCthulu"} onChange={props.handleInputChange} /> <br/>
          		Other:
          		...
          		<input name="roleplay" type="checkbox" value={"props.userToEdit.roleplay"} onChange={props.handleInputChange} /> <br/>
          		Combat (a game with a focus on fighting monsters and villians)
          		<input name="combat" type="checkbox" value={"props.userToEdit.combat"} onChange={props.handleInputChange} /> <br/>
          		Dungeon Crawl (a game with a focus on exploring elaborate maps with traps, monsters, and treasure!)
          		<input name="dungeonCrawl" type="checkbox" value={"props.userToEdit.dungeonCrawl"} onChange={props.handleInputChange} /> <br/>
          		Other
